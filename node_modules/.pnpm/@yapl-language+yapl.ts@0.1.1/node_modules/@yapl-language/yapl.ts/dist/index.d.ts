...
export declare class YAPL {
    ...
    render(templatePath: string, vars?: Record<string, unknown>): Promise<Prompt>;
}
...
declare class YAPLRenderer {
    ...
    private _loadFile?;
    private _ensureExtension;
    get loadFile(): ((absolutePath: string) => Promise<string>) | undefined;
    get resolvePath(): ((templateRef: string, fromDir: string, ensureExt: (p: string) => string) => string) | undefined;
    get ensureExtension(): (p: string) => string;
